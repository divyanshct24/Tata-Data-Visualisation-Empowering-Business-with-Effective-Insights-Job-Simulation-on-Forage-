...
In this task, you will create the visuals around four of the questions that the CEO and CMO have requested. You can use either Tableau or Power BI to create the visuals and we have provided the data in the resources below. 
...
Your video should be approximately 5 minutes in length.
...
REFERENCE - https://insideainews.com/2018/03/28/data-scientists-guide-communicating-results/
